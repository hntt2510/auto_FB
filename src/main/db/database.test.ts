...
describe('workspace persistence', () => {
  it('creates workspace tables with foreign keys and survives reopen', () => withDatabase((db) => {
    ...
    for (const table of ['groups', 'group_tags', 'account_groups', 'drafts', 'media_assets', 'draft_media', 'queue_items', 'queue_item_media', 'publish_attempts', 'publish_attempt_events', 'publish_receipts', 'account_publish_blocks']) {

...
export type TextboxCandidateSummary = { strategy?: string; tag?: string; role?: string; contenteditable?: string; ariaLabel?: string; placeholder?: string; ariaMultiline?: string; lexicalEditor?: string; visible?: boolean };
